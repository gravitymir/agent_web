...
export const el = {
  ...
  partyNamePop: document.getElementById("party-name-pop"),
  partyNameInput: document.getElementById("party-name-input"),
  partyNameHint: document.getElementById("party-name-hint"),
  partyNameSet: document.getElementById("party-name-set"),
